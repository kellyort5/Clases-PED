...
{
    cout << endl;
    cout << "ADMINISTRACION DE UNA COLA CON UNA LISTA LINEAL SIMPLEMENTE ENLAZADA" << endl
         << endl;
...
Cola::~Cola()
{
    ...
    while (pCola)
    {
        cout << "Estoy en la iteracion" << endl;
        p = pCola;
        pCola = pCola->sig;
        delete p;
    }
...
void Cola::eliminarUno()
{
    ...
    if (!pCola)
        cout << "La cola esta vacia, no de puede eliminar nada" << endl;
    else
    {
        saltarin1 = pCola;
        saltarin2 = NULL;
